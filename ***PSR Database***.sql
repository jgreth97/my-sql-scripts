...
values 
('XXXXXXX', 'Michael Scarn', '305 Scaranton Ave','Scarnaton', 'PA', '90210', '111-111-1111', 'MikeScarn@yahoo.com');
...
Satus varchar(20) not null default 'New',
...
select * from User, Vendor, Product, Request, LineItem;
